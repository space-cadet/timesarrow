\section{\texorpdfstring{\(Z_2\) Action and Time Reversal in Spin Networks}{Z\_2 Action and Time Reversal in Spin Networks}}\label{sec:z2-action}
...
\subsection{\texorpdfstring{The \(Z_2\) Gauge Field on Spin Networks}{The Z\_2 Gauge Field on Spin Networks}}\label{subsec:z2-definition}
...
\subsection{\texorpdfstring{Effective Action for the \(Z_2\) Field}{Effective Action for the Z\_2 Field}}\label{subsec:z2-effective-action}
...
\item
  \textbf{Confined phase} (\(K < K_c\)): The \(Z_2\) flux is disordered. The Wilson loop observable:
