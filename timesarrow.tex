...
\end{align}
Here the $ \ket{0}, \ket{1} $ are the two possible states of each edge carrying a spin $ 1/2 $ label. One can then write down the effective degrees of freedom carried by a four-valent intertwiner in terms of a single spin $ 1/2 $ state $ \ket{\tilde\Psi} $ spanned by the invariant basis states $ \{\ket{\Psi_1}, \ket{\Psi_2}\} $:
