...
figureFiles = [
  ...
  // Old first-order figures (SUPERSEDED — see T32-T20d correction)
  {id: "t20-binder-first-order-scaling", title: "❌ First-Order Scaling (SUPERSEDED)", desc: "INVALID — synthetic illustration, not sampled data"},
  {id: "t20-binder-first-order-scaling-all-L", title: "❌ First-Order All L (SUPERSEDED)", desc: "INVALID — superseded by T20d Ising FSS reanalysis"},
  {id: "t20-scaling-collapse", title: "❌ Scaling Collapse (SUPERSEDED)", desc: "INVALID — inconclusive without autocorrelation-aware errors"},
  {id: "t20-scaling-collapse-all-L", title: "❌ Scaling Collapse All L (SUPERSEDED)", desc: "INVALID — superseded by T20d Ising FSS reanalysis"},
  {id: "t20-critical-exponents", title: "❌ Critical Exponents (SUPERSEDED)", desc: "INVALID — unreliable with only 2 lattice sizes"},
  {id: "t20-first-order-scaling-summary", title: "❌ First-Order Summary (SUPERSEDED)", desc: "INVALID — withdrawn first-order interpretation"},
  // Scaling analysis
  {id: "t20-binder-first-order-scaling", title: "First-Order Scaling", desc: "Binder cumulant first-order scaling"},
  {id: "t20-binder-first-order-scaling-all-L", title: "First-Order All L", desc: "First-order scaling across all L"},
  {id: "t20-scaling-collapse", title: "Scaling Collapse", desc: "Finite-size scaling collapse"},
  {id: "t20-scaling-collapse-all-L", title: "Scaling Collapse All L", desc: "Scaling collapse all L sizes"},
  {id: "t20-critical-exponents", title: "Critical Exponents", desc: "Critical exponent extraction"},
  {id: "t20-first-order-scaling-summary", title: "First-Order Summary", desc: "Summary of first-order evidence"},
