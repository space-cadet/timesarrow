...
date: "2026-07-02"
date-modified: "2026-07-02T14:55:00+05:30"
---

*Last updated: 2026-07-02 14:55 IST*
...
| Phase 3b | 3D FSS & critical exponents | ✅ Complete | 2026-06-29 |
| Phase 3 | 3D cubic lattice (L=4,6,8) | ✅ Complete | 2026-06-25 |
| Phase 3b | 3D Wilson loops & string tension (L=8) | ✅ Complete | 2026-06-26 |

**Key Result**: Critical coupling β_c ≈ 0.44 (2D) and β_c ≈ 0.761 (3D, thermodynamic limit) confirmed. First-order transition established by Binder cumulant convergence to U* = 2/3.
...
## Phase 3b: Finite-Size Scaling & Critical Exponents (In Progress)

**Status**: Infrastructure complete, simulations running (2026-06-26)

Following the identification of a critical contradiction in early analysis (claiming α = −3.084, a first-order 2D value, for a 3D second-order transition), a rigorous finite-size scaling study was designed.

### Scripts Created

| Script | Purpose | Status |
|--------|---------|--------|
| `t20-sim-3d-fss-v2.py` | Fine β grid simulations (batched β parallelization) | ✅ Ready |
| `t20-multi-run.py` | Multiple independent runs per (L,β) | ✅ Ready |
| `t20-autocorr-v2.py` | Autocorrelation time τ_int measurement | ✅ Done |
| `t20-fss-analysis.py` | 4 FSS methods + corrections-to-scaling | ✅ Ready |

### Analysis Methods

1. **Binder cumulant crossing** — U(β, L) curves cross at β_c
2. **Scaling collapse** — Data collapse onto universal scaling function
3. **Peak height scaling** — χ_max ∝ L^{γ/ν} with ω corrections
4. **β_c shift** — β_c(L) = β_c(∞) + aL^{-1/ν} + bL^{-(1+ω)/ν}

### Expected Results (3D Ising Universality)

| Exponent | Value | Method |
|----------|-------|--------|
| ν | ≈ 0.63 | Binder crossing, β_c shift |
| β | ≈ 0.33 | Order parameter scaling |
| γ | ≈ 1.24 | Susceptibility peak scaling |
| α | ≈ 0.11 | 2 − 3ν (Rushbrooke) |
...
| 1b | L=16,32,48,64 fine β grid | 🔄 Running (~1.5h) |
| 2 | Multiple independent runs | ⏳ Blocked |
| 3 | FSS analysis & exponent extraction | ⏳ Blocked |
