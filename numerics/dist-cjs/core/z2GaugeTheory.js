...
exports.initializeZ2Lattice = initializeZ2Lattice;
exports.computePlaquette = computePlaquette;
exports.computeWilsonLoop = computeWilsonLoop;
exports.computeAction = computeAction;
/**
 * Initialize random Z₂ gauge configuration (cold or hot start)
 */
function initializeZ2Lattice(config, start = 'hot') {
    const links = new Map();
 ...
 */
function computePlaquette(links, x, y, z, dir1, dir2, L) {
 ...
 */
function computeWilsonLoop(links, path, L) {
    let product = 1;
 ...
 */
function computeAction(links, config) {
    let S = 0;
    const { L, K } = config;
