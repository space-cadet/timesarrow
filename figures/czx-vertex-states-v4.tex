...
\tikzset{
  ...
  \node[spin, scale=1.5] (s1) at (-1,1) {$ \vert 1 \rangle $};
  \node[spin, scale=1.5] (s2) at (1,1) {$ \vert 0 \rangle $};
  \node[spin, scale=1.5] (s3) at (1,-1) {$ \vert 0 \rangle $};
  \node[spin, scale=1.5] (s4) at (-1,-1) {$ \vert 1 \rangle $};
